...
class ProducttsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create productt" do
    assert_difference("Productt.count") do
      post productts_url, params: { productt: { name: @productt.name, price: @productt.price, vendor: @productt.vendor } }
    end
  ...
  test "should update productt" do
    patch productt_url(@productt), params: { productt: { name: @productt.name, price: @productt.price, vendor: @productt.vendor } }
